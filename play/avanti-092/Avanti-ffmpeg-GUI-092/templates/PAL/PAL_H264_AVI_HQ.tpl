...
tpl_com=h264 in AVI container / general example using FFmpeg defaults.You can change 'Bitrate' and "Frame size' as desired.You can adapt the basic settings and commands at the "FFmpeg Script Editor".
